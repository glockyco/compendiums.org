...
The brand should feel like a well-kept game-tools workshop: useful, direct, maintained by someone who cares about accuracy, and polished enough to trust without becoming corporate or overproduced.

## Anti-references

Do not make the apex domain look like it belongs to only one game. Ancient Kingdoms, Ardenfall, and Erenshor can each retain their own tone on their own subdomains; the parent site should not inherit one project's visual identity wholesale.
...
Target WCAG AA. The landing page must use semantic landmarks and headings, keyboard-reachable links, visible focus states, body-text contrast of at least 4.5:1, large-text contrast of at least 3:1, and reduced-motion alternatives for any animation.
